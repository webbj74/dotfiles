...
sudo systemsetup -settimezone "UTC" > /dev/null
...
tell application "Terminal"
	...
	do shell script "open '$HOME/src/dotfiles/theme/" & themeName & ".terminal'"
...
open "${HOME}/src/dotfiles/theme/Solarized Dark.itermcolors"
